...
run_command_test "compile recursive bytecode" 0 "Bytecode saved successfully: $TMP_DIR/recursion.lbc" \
    "$COMPILER" compile tests_stage8/recursion.lw -o "$TMP_DIR/recursion.lbc"
